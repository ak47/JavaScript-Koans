...
test("self invoking functions", function() {		
    ...
    (function(pv) {
        ...
        equals(typeof(secretValue), "password, "is secretValue available in this context?");
        equals(typeof(publicValue), "shared", "is publicValue available in this context?");
    })(publicValue);

    equals(typeof(secretValue), null, "is secretValue available in this context?");
    equals(typeof(publicValue), "shared", "is publicValue available in this context?");
});
...
test("using apply to invoke function",function(){
    ...
    //function and an array of arguments to be passed into the called function.
